...
def den_ene_to_p(rho, t_0, a_bar, z_bar, e_want, iter_times, error_limit):
    ...
    print(10**np.array(get_lge_dlgedlgt(8.e6, pow(10, 9.75))))
    print((np.array(get_pressure(8.e6, pow(10, 9.75)))))
    print(10**np.array(get_lge_dlgedlgt(1.e7, pow(10, 9.7))))
    print((np.array(get_pressure(1.e7, pow(10, 9.7)))))
    print(10**(np.array(get_lge_dlgedlgt(5.e-8, pow(10, 8.25)))))
    print((np.array(get_pressure(5.e-8, pow(10, 8.25)))))
    return t_0, pre_out



print(den_ene_to_p(8.e6, 1.4e9, 1, 1, pow(10, 18), 1000, 1.e-5))
